	...
	<div class="flex h-screen overflow-hidden">
		...
		<aside
			...
			<div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
				...
				<a href="<?php echo getUrl('dashboard') ?>"> <span class="logo"
					:class="sidebarToggle ? 'hidden' : ''"> <img class="dark:hidden"
						src="<?php echo getUrl('assets/dashboard/images/logo/logo.svg') ?>"
						alt="Logo" /> <img class="hidden dark:block"
						src="<?php echo getUrl('assets/dashboard/images/logo/logo-dark.svg') ?>"
						alt="Logo" />
				</span> <img class="logo-icon"
					:class="sidebarToggle ? 'lg:block' : 'hidden'"
					src="<?php echo getUrl('assets/dashboard/images/logo/logo-icon.svg') ?>"
					alt="Logo" />
				</a>
			</div>
			<!-- SIDEBAR HEADER -->
					...
					<div>
						<h3 class="mb-4 text-xs uppercase leading-[20px] text-gray-400">
							<span class="menu-group-title"
								:class="sidebarToggle ? 'lg:hidden' : ''"> MENU </span>

							<svg :class="sidebarToggle ? 'lg:block hidden' : 'hidden'"
								class="mx-auto fill-current menu-group-icon" width="24"
            ...
            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
											...
											fill="" />
              </svg> <span class="menu-item-text"
									:class="sidebarToggle ? 'lg:hidden' : ''"> Forms </span> <svg
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
									...
									:class="sidebarToggle ? 'lg:hidden' : ''"> Tables </span> <svg
										class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
		...
		<div
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
							...
							<svg :class="sidebarToggle ? 'hidden' : 'block lg:hidden'"
								class="fill-current lg:hidden" width="24" height="24"
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
							...
							<svg :class="sidebarToggle ? 'block lg:hidden' : 'hidden'"
								class="fill-current" width="24" height="24" viewBox="0 0 24 24"
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
						...
						<a href="<?php echo getUrl('dashboard') ?>" class="lg:hidden"> <img
							class="dark:hidden"
							src="<?php echo getUrl('assets/dashboard/images/logo/logo.svg') ?>"
							alt="Logo" /> <img class="hidden dark:block"
							src="<?php echo getUrl('assets/dashboard/images/logo/logo-dark.svg') ?>"
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
						...
						<div class="hidden lg:block">
							<form>
								<div class="relative">
									<span class="absolute top-1/2 left-4 -translate-y-1/2"> <svg
											class="fill-gray-500 dark:fill-gray-400" width="20"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
										...
										placeholder="Search or type command..." id="search-input"
              ...
              <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
									...
									<ul
										...
										<li><a
											...
											href="#"> <span
												class="relative z-1 block h-10 w-full max-w-10 rounded-full">
													<img
													src="<?php echo getUrl('assets/dashboard/images/user/user-02.jpg') ?>"
													alt="User" class="overflow-hidden rounded-full" /> <span
													...
													class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">
														...
														class="h-1 w-1 rounded-full bg-gray-400"></span> <span>5
															min ago</span>
												</span>
											</span>
										</a></li>
										...
										<li><a
											...
											href="#"> <span
												class="relative z-1 block h-10 w-full max-w-10 rounded-full">
													<img
													src="<?php echo getUrl('assets/dashboard/images/user/user-03.jpg') ?>"
													alt="User" class="overflow-hidden rounded-full" /> <span
													class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
											</span> <span class="block"> <span
													class="text-theme-sm mb-1.5 block text-gray-500 dark:text-gray-400">
													...
													class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">
														<span>Project</span> <span
														class="h-1 w-1 rounded-full bg-gray-400"></span> <span>8
															min ago</span>
												</span>
											</span>
										</a></li>
										...
										<li><a
											...
											href="#"> <span
												class="relative z-1 block h-10 w-full max-w-10 rounded-full">
													<img
													src="<?php echo getUrl('assets/dashboard/images/user/user-04.jpg') ?>"
													alt="User" class="overflow-hidden rounded-full" /> <span
													class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
											</span> <span class="block"> <span
													class="text-theme-sm mb-1.5 block text-gray-500 dark:text-gray-400">
														<span class="font-medium text-gray-800 dark:text-white/90">Jocelyn
															Kenter</span> requests permission to change <span
														class="font-medium text-gray-800 dark:text-white/90">Project
															- Nganter App</span>
												</span> <span
													class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">
														<span>Project</span> <span
														class="h-1 w-1 rounded-full bg-gray-400"></span> <span>15
															min ago</span>
												</span>
											</span>
										</a></li>
										...
										<li><a
											...
											href="#"> <span
												class="relative z-1 block h-10 w-full max-w-10 rounded-full">
													<img
													src="<?php echo getUrl('assets/dashboard/images/user/user-05.jpg') ?>"
													alt="User" class="overflow-hidden rounded-full" /> <span
													...
													class="text-theme-sm mb-1.5 block text-gray-500 dark:text-gray-400">
														<span class="font-medium text-gray-800 dark:text-white/90">Brandon
															Philips</span> requests permission to change <span
														class="font-medium text-gray-800 dark:text-white/90">Project
															- Nganter App</span>
												</span> <span
													class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">
														<span>Project</span> <span
														class="h-1 w-1 rounded-full bg-gray-400"></span> <span>1
															hr ago</span>
												</span>
											</span>
										</a></li>
						...
						<div class="relative" x-data="{ dropdownOpen: false }"
							@click.outside="dropdownOpen = false">
							<a class="flex items-center text-gray-700 dark:text-gray-400"
								href="#" @click.prevent="dropdownOpen = ! dropdownOpen"> <span
								class="mr-3 h-11 w-11 overflow-hidden rounded-full"> <img
									src="<?php echo getUrl('assets/dashboard/images/user/owner.jpg') ?>"
									alt="User" />
							</span> <span class="text-theme-sm mr-1 block font-medium">
							<?php
    $cuser = getCurrentUser();
    ?>
									<?php echo $cuser->realname ?> </span> <svg
									:class="dropdownOpen && 'rotate-180'"
									class="stroke-gray-500 dark:stroke-gray-400" width="18"
            ...
            <path d="M4.3125 8.65625L9 13.3437L13.6875 8.65625"
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
								...
								<a href="<?php echo getUrl('login/logout') ?>"
