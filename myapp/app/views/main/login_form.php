				...
				<div>
					<div class="mb-5 sm:mb-8">
						<h1
							...
							Sign In</h1>
						<p class="text-sm text-gray-500 dark:text-gray-400">Enter your
							email and password to sign in!</p>
					...
					<div>
                      ...
                      <path
							...
							<button
								class="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
								<svg width="21" class="fill-current" height="20"
                      ...
                      <path
						...
						<form action="<?php echo getUrl('login') ?>" method="post"
                            ...
                            <path fill-rule="evenodd"
												...
												class="fill-current" width="20" height="20"
                            ...
                            <path fill-rule="evenodd"
								...
								<div class="flex items-center justify-between">
									<a href="<?php echo getUrl('login/forgotpass') ?>"
