				...
				<nav>
					<ol class="flex items-center gap-1.5">
						<li><a
							...
							href="<?php echo getUrl('dashboard') ?>"> Home <svg
									class="stroke-current" width="17" height="16"
				...
				<div
					...
					<div
						...
						<div>
							<label
								class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
								Input with Placeholder </label> <input type="text"
							...
							<div x-data="{ isOptionSelected: false }"
								...
								<select
									...
									<svg class="stroke-current" width="20" height="20"
										...
										xmlns="http://www.w3.org/2000/svg">
                            <path
											d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke=""
							...
							<div class="relative">
								...
								<span
									...
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
										xmlns="http://www.w3.org/2000/svg">
                            <circle cx="6.25" cy="10" r="5.625"
											fill="#E80B26" />
                            <circle cx="13.75" cy="10" r="5.625"
											fill="#F59D31" />
                            <path
															...
															<div
																...
																<div class="flex flex-auto flex-row-reverse">
																	<div @click="remove(index,option)"
																		...
																		<svg class="fill-current" role="button" width="14"
					...
					<div
						...
						<div>
							<label
								class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
								Description </label>
							<textarea placeholder="Enter a description..." type="text"
								rows="6"
						...
						<div>
							...
							<p class="text-theme-xs text-error-500">Please enter a message in
								the textarea.</p>
						</div>
					</div>
				</div>
					...
					<div
						...
						<div>
							...
							<div class="relative">
								...
								<span class="absolute top-1/2 right-3.5 -translate-y-1/2"> <svg
							...
							<p class="text-theme-xs text-error-500 mt-1.5">This is an error
								message.</p>
						</div>
						...
						<div>
							...
							<p class="text-theme-xs text-success-500 mt-1.5">This is an
								success message.</p>
						</div>
						...
						<div>
							<label
								class="mb-1.5 block text-sm font-medium text-gray-300 dark:text-white/15">
								Email </label> <input type="text" placeholder="info@gmail.com"
								disabled
					...
					<div
						...
						<div>
                            ...
                            <path fill-rule="evenodd"
								...
								</span> <input type="text" placeholder="info@gmail.com"
							...
							<div class="relative">
								<div class="absolute">
									<select x-model="selectedCountry"
										...
										<option value="US"
											class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">US
										</option>
										<option value="GB"
											class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">GB
										</option>
										<option value="CA"
											class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">CA
										</option>
										<option value="AU"
											class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">AU
										</option>
                              ...
                              <path
								...
								<input placeholder="+1 (555) 000-0000" x-model="phoneNumber"
									type="tel"
						...
						<div class="flex flex-wrap items-center gap-8">
								...
								<label for="checkboxLabelOne"
									...
									<div class="relative">
										...
										<div
											...
											<span :class="checkboxToggle ? '' : 'opacity-0'"> <svg
													width="14" height="14" viewBox="0 0 14 14" fill="none"
													xmlns="http://www.w3.org/2000/svg">
                                  <path
														d="M11.6666 3.5L5.24992 9.91667L2.33325 7" stroke="white"
							...
							<div x-data="{ checkboxToggle: true }">
								<label for="checkboxLabelThree"
									...
									<div class="relative">
										<input type="checkbox" id="checkboxLabelThree"
											class="peer sr-only"
										...
										<div
											...
											<span :class="checkboxToggle ? '' : 'opacity-0'"> <svg
													class="stroke-gray-200 dark:stroke-gray-800" width="14"
													height="14" viewBox="0 0 14 14" fill="none"
													xmlns="http://www.w3.org/2000/svg">
                                  <path
														d="M11.6666 3.5L5.24992 9.91667L2.33325 7" stroke=""
						...
						<div class="flex flex-wrap items-center gap-8">
							...
							<div x-data="{ checkboxToggle: false }">
								<label for="radioLabelThree"
									class="flex cursor-pointer items-center text-sm font-medium text-gray-300 select-none dark:text-gray-700">
									<div class="relative">
										<input type="checkbox" id="radioLabelThree"
											class="peer sr-only"
											@change="checkboxToggle = !checkboxToggle" disabled />
										<div
								...
								<label for="toggle3"
									...
									<div class="relative">
										<input type="checkbox" id="toggle3" class="sr-only"
											@change="switcherToggle = !switcherToggle" disabled />
										<div class="block h-6 w-11 rounded-full"
						...
						<div class="flex flex-wrap items-center gap-6 sm:gap-8">
							<div x-data="{ switcherToggle: false }">
								<label for="toggle11"
									class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
									<div class="relative">
										<input type="checkbox" id="toggle11" class="sr-only"
											@change="switcherToggle = !switcherToggle" />
										<div
							...
							<div x-data="{ switcherToggle: true }">
								<label for="toggle22"
									class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
									<div class="relative">
										<input type="checkbox" id="toggle22" class="sr-only"
											@change="switcherToggle = !switcherToggle" />
										<div
											class="block h-6 w-11 rounded-full bg-gray-700 dark:bg-white/10"></div>
										<div
							...
							<div x-data="{ switcherToggle: false }">
								<label for="toggle33"
									class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-400 select-none">
									<div class="relative">
										<input type="checkbox" id="toggle33" class="sr-only"
											@change="switcherToggle = !switcherToggle" disabled />
										<div
