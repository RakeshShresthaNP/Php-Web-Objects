...
* **Identity_verified Gate & 2FA: Built-in, zero-dependency Two-Factor Authentication (TOTP) supporting Microsoft Authenticator, Google Authenticator and Authy with native QR Code provisioning.
